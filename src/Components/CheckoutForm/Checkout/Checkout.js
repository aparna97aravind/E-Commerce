...
const Form = () => activeStep === 0 ? <AddressForm checkoutToken = {checkoutToken} proceed={proceedToPay}/> : <PaymentForm shippingData={shippingData} checkoutToken={checkoutToken} backStep={backStep} nextStep={nextStep}/>
